...
?>
               ...
               <tr>
                   ...
                   <td><input type ="file" name="c_image" required/><img src="customer_images/<?php echo $image; ?>"
    ...
    $ip = getIp();
     ...
     //image
      move_uploaded_file($c_image_tmp, "customer_images/$c_image");
       ...
       $update_c ="update customers set customer_name='$c_name', customer_email='$c_email',customer_pass='$c_pass', customer_image='$c_image', customer_city='$c_city', customer_contact='$c_contact', customer_address='$c_address' where customer_id='$customer_id' ";
      ...
      $run_update = mysqli_query($con,$update_c);
       ...
       if($run_update){
        ...
        echo "<script>alert('Account has successfully been updated!')</script>";
